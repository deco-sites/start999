...
const MigrationBanner = ({ file } : Props) => {  
  return (
    <div className="background-arrows bg-[url('https://t3.ftcdn.net/jpg/00/86/56/12/360_F_86561234_8HJdzg2iBlPap18K38mbyetKfdw1oNrm.jpg')] flex flex-col items-center justify-center text-center h-screen bg-blue-900 text-white">
      <img src={file} />
